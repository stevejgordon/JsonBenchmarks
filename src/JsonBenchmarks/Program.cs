...
//var b = new JsonBenchmarks();
//b.Setup();
//await b.SystemTextJsonBenchmark();
...
public class JsonBenchmarks
{
  ...
  ""active_shards_percent_as_number"": 50.0
    ...
    {
        _stream.Position = 0;
        ClusterHealthResponse = await System.Text.Json.JsonSerializer.DeserializeAsync<ClusterHealthResponse>(_stream, _jsonOptions);
    }
}
